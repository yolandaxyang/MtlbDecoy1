...
save(['C:\Users\Yolanda Yang\Desktop\data' filesep 'doubledecoy' num2str(subid) '-' datestr(datetime('now'),'yyyy-mm-dd-HH.MM.SS') '.mat'],'dd_choiceset','dd_choice','dd_time', 'ix', 'dd_target','dd_comp','dd_probchosen','dd_payoff');